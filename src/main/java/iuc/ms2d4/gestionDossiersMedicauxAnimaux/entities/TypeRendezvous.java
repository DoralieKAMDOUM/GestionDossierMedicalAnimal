 ...
 */
@Entity
@Table(name = "type_rendezvous", catalog = "gestanimaux", schema = "")
@NamedQueries({
...
public class TypeRendezvous implements Serializable {
    ...
    @Column(name = "ID_TYPERENDEZVOUS", nullable = false)
    ...
    public String toString() {
        return "iuc.ms2d4.gestionDossiersMedicauxAnimaux.TypeRendezvous[ idTyperendezvous=" + idTyperendezvous + " ]";
    }
